...
<head>
  ...
  <script type="text/javascript" src="js/reports-xml.js"></script>
   ...
   <li>
     ...
     <li>
        ...
        <div class="row"></div>
                  ...
                  <div class="col-lg-12">
                    <h5>Reports Currently in Database</h5>
                  </div>
                  <div class="row"></div>
              

<body onload="selectReport()">

<!-- POST Request and Return XML -->                                     
              <div class="col-xs-12 col-sm-10" id="typeOfReport"></div>                        
